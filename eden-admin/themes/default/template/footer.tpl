...
{if $display_footer}
	<div id="footer" class="bootstrap hide">
		...
		<div class="col-sm-2 hidden-xs">
			...
			-
			<span id="footer-load-time"><i class="icon-time" title="{l s='Load time: '}"></i>
				{number_format(microtime(true) - $timer_start, 3, '.', '')}s</span>
		</div>
		...
		<div class="col-sm-2 hidden-xs">
			{* <div class="social-networks">
				...
				<a class="link-social link-google _blank" href="https://plus.google.com/110221570427070809661"
					title="Google">
